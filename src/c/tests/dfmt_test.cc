...
TEST(DFmtTest, Regression) {
  ...
  ASSERT_DFMT("9060801153433600", 9.0608011534336e15);
...
TEST(DFmtTest, OutputLength) {
  ASSERT_DFMT("1", 1); // already tested in Basic
  ASSERT_DFMT("1.2", 1.2);
...
TEST(DfmtTest, SmallIntegers) {
  ASSERT_DFMT("9007199254740991", 9007199254740991.0); // 2^53-1
  ASSERT_DFMT("9007199254740992", 9007199254740992.0); // 2^53

  ASSERT_DFMT("1", 1.0e0);
  ASSERT_DFMT("12", 1.2e1);
  ASSERT_DFMT("123", 1.23e2);
  ASSERT_DFMT("1234", 1.234e3);
  ASSERT_DFMT("12345", 1.2345e4);
  ASSERT_DFMT("123456", 1.23456e5);
  ASSERT_DFMT("1234567", 1.234567e6);
  ASSERT_DFMT("12345678", 1.2345678e7);
  ASSERT_DFMT("123456789", 1.23456789e8);
  ASSERT_DFMT("1234567890", 1.23456789e9);
  ASSERT_DFMT("1234567895", 1.234567895e9);
  ASSERT_DFMT("12345678901", 1.2345678901e10);
  ASSERT_DFMT("123456789012", 1.23456789012e11);
  ASSERT_DFMT("1234567890123", 1.234567890123e12);
  ASSERT_DFMT("12345678901234", 1.2345678901234e13);
  ASSERT_DFMT("123456789012345", 1.23456789012345e14);
  ASSERT_DFMT("1234567890123456", 1.234567890123456e15);

  // 10^i
  ASSERT_DFMT("1", 1.0e+0);
  ASSERT_DFMT("10", 1.0e+1);
  ASSERT_DFMT("100", 1.0e+2);
  ASSERT_DFMT("1000", 1.0e+3);
  ASSERT_DFMT("10000", 1.0e+4);
  ASSERT_DFMT("100000", 1.0e+5);
  ASSERT_DFMT("1000000", 1.0e+6);
  ASSERT_DFMT("10000000", 1.0e+7);
  ASSERT_DFMT("100000000", 1.0e+8);
  ASSERT_DFMT("1000000000", 1.0e+9);
  ASSERT_DFMT("10000000000", 1.0e+10);
  ASSERT_DFMT("100000000000", 1.0e+11);
  ASSERT_DFMT("1000000000000", 1.0e+12);
  ASSERT_DFMT("10000000000000", 1.0e+13);
  ASSERT_DFMT("100000000000000", 1.0e+14);
  ASSERT_DFMT("1000000000000000", 1.0e+15);

  // 10^15 + 10^i
  ASSERT_DFMT("1000000000000001", 1.0e+15 + 1.0e+0);
  ASSERT_DFMT("1000000000000010", 1.0e+15 + 1.0e+1);
  ASSERT_DFMT("1000000000000100", 1.0e+15 + 1.0e+2);
  ASSERT_DFMT("1000000000001000", 1.0e+15 + 1.0e+3);
  ASSERT_DFMT("1000000000010000", 1.0e+15 + 1.0e+4);
  ASSERT_DFMT("1000000000100000", 1.0e+15 + 1.0e+5);
  ASSERT_DFMT("1000000001000000", 1.0e+15 + 1.0e+6);
  ASSERT_DFMT("1000000010000000", 1.0e+15 + 1.0e+7);
  ASSERT_DFMT("1000000100000000", 1.0e+15 + 1.0e+8);
  ASSERT_DFMT("1000001000000000", 1.0e+15 + 1.0e+9);
  ASSERT_DFMT("1000010000000000", 1.0e+15 + 1.0e+10);
  ASSERT_DFMT("1000100000000000", 1.0e+15 + 1.0e+11);
  ASSERT_DFMT("1001000000000000", 1.0e+15 + 1.0e+12);
  ASSERT_DFMT("1010000000000000", 1.0e+15 + 1.0e+13);
  ASSERT_DFMT("1100000000000000", 1.0e+15 + 1.0e+14);

  // Largest power of 2 <= 10^(i+1)
  ASSERT_DFMT("8", 8.0);
  ASSERT_DFMT("64", 64.0);
  ASSERT_DFMT("512", 512.0);
  ASSERT_DFMT("8192", 8192.0);
  ASSERT_DFMT("65536", 65536.0);
  ASSERT_DFMT("524288", 524288.0);
  ASSERT_DFMT("8388608", 8388608.0);
  ASSERT_DFMT("67108864", 67108864.0);
  ASSERT_DFMT("536870912", 536870912.0);
  ASSERT_DFMT("8589934592", 8589934592.0);
  ASSERT_DFMT("68719476736", 68719476736.0);
  ASSERT_DFMT("549755813888", 549755813888.0);
  ASSERT_DFMT("8796093022208", 8796093022208.0);
  ASSERT_DFMT("70368744177664", 70368744177664.0);
  ASSERT_DFMT("562949953421312", 562949953421312.0);
  ASSERT_DFMT("9007199254740992", 9007199254740992.0);

  // 1000 * (Largest power of 2 <= 10^(i+1))
  ASSERT_DFMT("8000", 8.0e+3);
  ASSERT_DFMT("64000", 64.0e+3);
  ASSERT_DFMT("512000", 512.0e+3);
  ASSERT_DFMT("8192000", 8192.0e+3);
  ASSERT_DFMT("65536000", 65536.0e+3);
  ASSERT_DFMT("524288000", 524288.0e+3);
  ASSERT_DFMT("8388608000", 8388608.0e+3);
  ASSERT_DFMT("67108864000", 67108864.0e+3);
  ASSERT_DFMT("536870912000", 536870912.0e+3);
  ASSERT_DFMT("8589934592000", 8589934592.0e+3);
  ASSERT_DFMT("68719476736000", 68719476736.0e+3);
  ASSERT_DFMT("549755813888000", 549755813888.0e+3);
  ASSERT_DFMT("8796093022208000", 8796093022208.0e+3);
}
