...
bazel run -c opt //benchmark:ryu_benchmark_shortest -- -bydigits -samples=250
bazel run -c opt //benchmark:ryu_benchmark_shortest -- -samples=250

printf "Generating charts for c\n"
...
TARGET=(//benchmark:ryu_benchmark_shortest -- "-samples=100")
